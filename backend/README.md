...
## Project Structure
    ...
    ├── testapiautoteammemb_66788  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_66788`
...
2. Clone this repo and `cd testapiautoteammemb_66788`
